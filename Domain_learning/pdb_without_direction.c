...
*********************************/
void find_compl(struct atom *atoms1, unsigned int *list_P, unsigned int *list_C1, unsigned int *list_OP1, unsigned int *list_OP2, struct atom *atoms1_P, unsigned int n_P, unsigned int *compl, unsigned int *first_chain_length, FILE *outputfile, char *infile1, char *infile2)
{
//atoms1 - all atoms
//atoms1_P - only P atoms
	...
	if (n_P2 == 0)
	{
		...
		fprintf(outputfile, "%s-%s\tError: 1ch\n", infile1, infile2);
		exit(1);
	}
