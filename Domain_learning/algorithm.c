...
int main  (int argc, char **argv)
{
  ...
  char *infile1, *infile2, *outfile, *S_file, *output_file;
...
/*  for (i=n_P1; i>=1; i--){
  ...
  find_compl(atoms_dna1, list_P1, list_C11, list_OP11, list_OP21, atoms_dna_P1, n_P1, &compl1, &n_first_chain, output, infile1, infile2);
  find_compl(atoms_dna2, list_P2, list_C12, list_OP12, list_OP22, atoms_dna_P2, n_P2, &compl2, &m_first_chain, output, infile1, infile2);
  BestDiag(list_measure, n_P1, n_P2, &S_max, &i_max, &j_max, &i_start, &j_start, &i_max_measure, &j_max_measure,
  	   atoms_dna1, list_P1, atoms_dna2, list_P2, compl1, compl2, n_first_chain, m_first_chain, infile1, infile2, S_outfile, output);
  // pdb.c function 
